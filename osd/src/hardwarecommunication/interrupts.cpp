...
InterruptManager::InterruptManager(uint16_t hardwareInterruptOffset, GlobalDescriptionTable* gdt, TaskManager* taskManager)
...
uint32_t InterruptManager::DoHandleInterrupt(uint8_t interruptNumber, uint32_t esp)
{
    ...
    {   
        ...
        // this is for printing the interrupt number
    }
